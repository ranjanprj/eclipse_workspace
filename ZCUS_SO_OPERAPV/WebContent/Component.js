sap.ui.define([
	...
	"sap/ui/Device",
	"com/slb/cus/operationalapproval/model/models",
	"com/slb/cus/operationalapproval/controller/ListSelector",
	"com/slb/cus/operationalapproval/controller/ErrorHandler",
	"com/slb/cus/operationalapproval/model/formatter",
	"com/slb/cus/operationalapproval/model/grouper"
], function(UIComponent, Device, models, ListSelector, ErrorHandler) {
	"use strict";

	return UIComponent.extend("com.slb.cus.operationalapproval.Component", {

		metadata: {
			"version": "1.0.0",
			"rootView": {
				"viewName": "com.slb.cus.operationalapproval.view.App",
				"type": "XML",
				"id": "app"
			},
			"dependencies": {
			...
			"config": {
				"i18nBundle": "com.slb.cus.operationalapproval.i18n.i18n",
				"serviceUrl": "/sap/opu/odata/SAP/ZCUS_SO_OPERATIONAL_APPROVAL_SRV/",
				"icon": "",
				"favIcon": "",
				"phone": "",
				"phone@2": "",
			...
			"routing": {
				"config": {
					...
					"viewType": "XML",
					"viewPath": "com.slb.cus.operationalapproval.view",

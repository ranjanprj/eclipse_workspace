sap.ui.define([
	...
	"sap/ui/Device",
	"com/slb/cus/billingapproval/model/models",
	"com/slb/cus/billingapproval/controller/ListSelector",
	"com/slb/cus/billingapproval/controller/ErrorHandler",
	...
	return UIComponent.extend("com.slb.cus.billingapproval.Component", {
//		"serviceUrl": "proxy/https/sapf2d.dir.slb.com:44310/sap/opu/odata/SAP/ZCUS_SO_BILLING_APPROVAL_SRV/",
		//"serviceUrl": "/sap/opu/odata/SAP/ZCUS_SO_BILLING_APPROVAL_SRV/",
		
		
		metadata: {
			"version": "1.0.0",
			"rootView": {
				"viewName": "com.slb.cus.billingapproval.view.App",
				"type": "XML",
				"id": "app"
			},
			"dependencies": {
			...
			"config": {
				"i18nBundle": "com.slb.cus.billingapproval.i18n.i18n",			
			...
			"routing": {
				"config": {
					...
					"viewType": "XML",
					"viewPath": "com.slb.cus.billingapproval.view",
				...
				"routes": [{
					...
					"pattern": "SalesOrderHeaderSet/{objectId}",
					"name": "object",

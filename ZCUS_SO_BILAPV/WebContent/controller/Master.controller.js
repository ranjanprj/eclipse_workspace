...
sap.ui.define([
	...
	"com/slb/cus/billingapproval/model/grouper"
], function(BaseController, JSONModel, Filter, FilterOperator, Sorter, GroupHeaderListItem, Device, formatter, grouper) {
	"use strict";

	return BaseController.extend("com.slb.cus.billingapproval.controller.Master", {
		...
		onOpenViewSettings: function() {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("com.slb.cus.billingapproval.view.ViewSettingsDialog", this);
			...
			aFilterItems.forEach(function(oItem) {
				...
				switch (oItem.getParent().getKey()) {
					...
					case "RIG_KEY":
						...
						break;
					case "SEG_KEY":
						aFilters.push(new Filter("Segment", FilterOperator.EQ, oItem.getKey()));
						break;
					case "SUB_SEG_KEY":
						aFilters.push(new Filter("SubSegment", FilterOperator.EQ, oItem.getKey()));
						break;
					default:
						break;

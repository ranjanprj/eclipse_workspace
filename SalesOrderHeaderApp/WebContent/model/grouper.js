sap.ui.define([], function() {
	...
	return {
		...
		/**
		 * Grouping function to group the master list by Id
		 * @public
		 * @param {object} oContext the current list item context
		 * @returns {object} an object with the Id as key and a text for the group headers
		 */
		Id: function(oContext) {
			var iPrice = oContext.getProperty("Id"),
				sKey,
				sText,

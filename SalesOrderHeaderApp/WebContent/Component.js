...
sap.ui.define([
	...
	"sap/ui/Device",
	"com/slb/cus/model/models",
	"com/slb/cus/controller/ListSelector",
	"com/slb/cus/controller/ErrorHandler",
	...
	return UIComponent.extend("com.slb.cus.Component", {
		...
		metadata: {
			...
			"config": {
				...
				"serviceUrl": "/SalesOrder/SalesOrder.svc",
				"icon": "",
				"favIcon": "",
				"phone": "",
				"phone@2": "",
			...
			"routing": {
				...
				"routes": [{
					...
					"pattern": "SalesOrderHeaders/{objectId}",
					"name": "object",
